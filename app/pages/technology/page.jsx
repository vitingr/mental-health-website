  ...
  return (
    <div>
      <section className='main-section'>
        <div className='flex-div card1-technology'>
          ...
          <div>
            <img src="/assets/images/undraw_visionary_technology_re_jfp7.svg" className='bgImg' alt="Foto" />
          </div>
        </div>

        <div className='flex-div card2-technology'>
          <div>
